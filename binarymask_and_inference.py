...
def main():
    ...
    input_image = np.load("data_out_dir/00000004time20140113.npy")
    ...
    mask_image = np.load("mask_out_dir/00000004time20140113.npy")
    ...
    normalised_lung_data = train_transforms(lung_data)
    normalised_lung_data = normalised_lung_data.detach().cpu().numpy()
    print("hello")

    # step 7: split the normalised lung data into 4 parts
    # step 7.1: split the normalised lung data into 2 parts
    normalised_lung_data_1 = normalised_lung_data[:, :, :normalised_lung_data.shape[2] // 2]
    normalised_lung_data_2 = normalised_lung_data[:, :, normalised_lung_data.shape[2] // 2:]
    # step 7.2: split the normalised lung data 1 into 2 parts
    normalised_lung_data_1_1 = normalised_lung_data_1[:, :normalised_lung_data_1.shape[1] // 2, :]
    normalised_lung_data_1_2 = normalised_lung_data_1[:, normalised_lung_data_1.shape[1] // 2:, :]
    # step 7.3: split the normalised lung data 2 into 2 parts
    normalised_lung_data_2_1 = normalised_lung_data_2[:, :normalised_lung_data_2.shape[1] // 2, :]
    normalised_lung_data_2_2 = normalised_lung_data_2[:, normalised_lung_data_2.shape[1] // 2:, :]

    # step 8: combine all the boxes obtained above and convert it into a numpy array
    boxes = np.concatenate((normalised_lung_data_1_1, normalised_lung_data_1_2, normalised_lung_data_2_1,
                            normalised_lung_data_2_2), axis=0)
    ...
    with torch.no_grad():
        ...
        raw_nii = nib.load("/home/adi/scripts/pycharm_project_lobeseg/lobe_seg_downsampled/data_dir/00000004time20140113.nii.gz")
        ...
        image_path = "/home/adi/scripts/pycharm_project_lobeseg/lobe_seg_downsampled/data_dir/00000004time20140113.nii.gz"
        ...
        multiple_clip_overlay_with_mask_from_npy(raw_nii.get_fdata(), label_map_filled, "coronal_latest_with_bounding_box_stitched_predicted_new.png",
                                                 clip_plane="coronal", img_vrange=(-1000, 0))
